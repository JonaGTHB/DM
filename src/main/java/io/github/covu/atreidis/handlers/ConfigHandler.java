...
package io.github.covu.atreidis.handlers;
...
public class ConfigHandler {
    ...
    public static void reloadConfig() {
        ...
        if (!hasKey("drm", "version")) {
            writeStringConfig("drm", "version", Atreides.VERSION);
            Atreides.firstLogin = true;
            //writeBooleanConfig("toggles", "waypointsToggled", false);
        } else if (!getString("drm", "version").equals(Atreides.VERSION)) {
            writeStringConfig("drm", "version", Atreides.VERSION);
        ...
        Atreides.textLocX = getInt("gui", "scaleX");
        Atreides.textLocY = getInt("gui", "scaleY");
        Atreides.imageHotkeyOpen = getString("gui", "hotkeyOpen");
    }
}
