...
import io.github.covu.atreidis.gui.LinkGUI;
...
public class OpenLink {
    ...
    public static void checkForLink(String type){
        ...
        if (RoomDetection.roomName.equals("undefined") || Atreides.roomsJson.get(RoomDetection.roomName) == null) {
            player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                    + "Dungeon Rooms: You do not appear to be in a detected Dungeon room right now."));
            return;
        }

        JsonObject roomJson = Atreides.roomsJson.get(RoomDetection.roomName).getAsJsonObject();
