...
package io.github.covu.atreidis;

import com.google.gson.Gson;
import com.google.gson.JsonObject;
import io.github.covu.atreidis.handlers.PacketHandler;
import io.github.covu.atreidis.commands.RoomCommand;
...
import io.github.covu.atreidis.handlers.TextRenderer;
...
@Mod(modid = Atreides.MODID, version = Atreides.VERSION)
public class Atreides
{
    public static final String MODID = "atreides";
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        ...
        //initialize logger
        logger = LogManager.getLogger(Atreides.class);
        Utils.setLogLevel(LogManager.getLogger(Atreides.class), Level.INFO);
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        keyBindings[3] = new KeyBinding("Receive Ghost Pickaxe", Keyboard.KEY_G, "Atreidis");
    ...
    public void postInit(final FMLPostInitializationEvent event) {
        ...
        Atreides.logger.info("DungeonRooms: SBP Dungeon Secrets detection: " + usingSBPSecrets);
    }
